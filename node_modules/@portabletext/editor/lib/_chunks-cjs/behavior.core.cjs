"use strict";
var selector_isAtTheStartOfBlock = require("./selector.is-at-the-start-of-block.cjs"), types = require("@sanity/types"), util_reverseSelection = require("./util.reverse-selection.cjs");
...
const arrowDownOnLonelyBlockObject = {
  ...
  guard: ({
    ...
    return !focusTextBlock || !selectionCollapsed || !previousBlock ? !1 : util_reverseSelection.isEmptyTextBlock(focusTextBlock.node) && !types.isPortableTextTextBlock(previousBlock.node) ? {
      focusTextBlock,
      previousBlock
    } : !1;
  },
  ...
  guard: ({
    ...
    return !focusTextBlock || !selectionCollapsed || !nextBlock ? !1 : util_reverseSelection.isEmptyTextBlock(focusTextBlock.node) && !types.isPortableTextTextBlock(nextBlock.node) ? {
      focusTextBlock,
      nextBlock
    } : !1;
  },
  ...
  guard: ({
    ...
    return !selectionCollapsed || !focusListBlock || !util_reverseSelection.isEmptyTextBlock(focusListBlock.node) ? !1 : {
      focusListBlock
    };
  },
  actions: [(_, {
